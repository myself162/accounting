...
role :web, "accounting.com"                          # Your HTTP server, Apache/etc
role :app, "accounting.com"                         # This may be the same as your `Web` server
role :db,  "accounting.com"   , :primary => true # This is where Rails migrations will run
